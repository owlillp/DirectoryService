...
public class SearchDepartmentsAncestorsTests(IntegrationTestsWebFactory factory) : DirectoryServiceTestsBase(factory)
{
    [Fact]
    public async Task SearchDepartmentAncestor_should_return_matching_departments()
    {
        // arrange
    ...
    [Fact]
    public async Task SearchDepartmentAncestor_with_no_match_should_return_empty()
    {
        // arrange
        var cancellationToken = new CancellationTokenSource().Token;
    ...
    [Fact]
    public async Task SearchDepartmentAncestor_should_return_ancestor_department_fields()
    {
        // arrange
        var cancellationToken = new CancellationTokenSource().Token;
    ...
    [Fact]
    public async Task SearchDepartmentAncestor_with_empty_name_should_fail()
    {
        // arrange
        var cancellationToken = new CancellationTokenSource().Token;
    ...
    [Fact]
    public async Task SearchDepartmentAncestor_with_invalid_page_should_fail()
    {
        // arrange
        var cancellationToken = new CancellationTokenSource().Token;
