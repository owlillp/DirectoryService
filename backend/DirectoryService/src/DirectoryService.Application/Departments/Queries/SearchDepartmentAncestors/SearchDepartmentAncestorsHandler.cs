...
public class SearchDepartmentsHandler(
    IValidator<SearchDepartmentAncestorsQuery> validator,
    IDbConnectionFactory connectionFactory)
    : IQueryHandler<PagedResult<AncestorDepartmentDto>, SearchDepartmentAncestorsQuery>
{
    ...
    public async Task<Result<PagedResult<AncestorDepartmentDto>, Errors>> Handle(SearchDepartmentAncestorsQuery query, CancellationToken cancellationToken)
    {
        ...
        var request = query.AncestorsRequest;
